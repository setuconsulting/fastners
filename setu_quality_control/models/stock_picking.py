...
class StockPicking(models.Model):
    ...
    check_ids = fields.One2many('setu.quality.check', 'picking_id', 'Checks')
    ...
    quality_alert_ids = fields.One2many('setu.quality.alert', 'picking_id', 'Alerts')
    ...
    def action_open_quality_check_picking(self):
        action = self.env["ir.actions.actions"]._for_xml_id("setu_quality_control.setu_quality_check_action_picking")
