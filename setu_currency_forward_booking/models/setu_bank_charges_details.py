...
class SetuBankChargesDetails(models.Model):
    _name = "setu.bank.charges.details"
    _description = "Setu Bank Charges Details"

    charge_amount = fields.Monetary(string="Charge Amount", currency_field='company_currency_id')
